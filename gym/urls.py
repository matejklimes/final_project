...
from .views import index, ExerciseListView, ExerciseDetailView, WorkoutListView, WorkoutDetailView, StartNewWorkoutView,WorkoutSummaryView, ExerciseJSONView, RunningWorkoutView
